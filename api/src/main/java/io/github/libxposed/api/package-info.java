 ...
 *
 * <p>Module entry classes should extend {@link io.github.libxposed.api.XposedModule};
 * modules <b>should not</b> perform initialization work before
 ...
 *     <li>{@code exceptionMode} (string) [protective|passthrough] - Default to protective</li>
